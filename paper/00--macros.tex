% ToDo stuff
\newcommand{\Xsays}[3]   {\todo[inline,color=#2]{\textbf{#1 says:} #3}}
\newcommand{\Ysays}[1]   {\Xsays{Ying}{green!40}{#1}}
\newcommand{\Psays}[1]   {\Xsays{Pascal}{orange!40}{#1}}
\newcommand{\Ssays}[1]   {\Xsays{Songtuan}{purple!40}{#1}}
% \renewcommand{\Xsays}[3] {}
