...
For an visual demonstration of what this algorithm is doing:
...
\todo{Most notably, note that TO problems allow for other visited list
	configurations than PO problems. So we should also use a TO
	configuration there (this is however not reported)}
